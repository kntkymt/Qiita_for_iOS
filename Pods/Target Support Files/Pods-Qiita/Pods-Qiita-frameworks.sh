...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PluggableAppDelegate/PluggableAppDelegate.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/WebViewWarmupper/WebViewWarmupper.framework"
fi
